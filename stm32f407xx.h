...
/*
 * Base Addresses of GPIO peripheral which are connected AHB1 bus
 */
...
typedef struct{
	...
	__vo uint32_t OTYPER;      /* GPIO port mode register Address Offset : 0x00 */
	__vo uint32_t OSPEEDR;      /* GPIO port mode register Address Offset : 0x00 */
	__vo uint32_t PUPDR;      /* GPIO port mode register Address Offset : 0x00 */
	__vo uint32_t IDR;      /* GPIO port mode register Address Offset : 0x00 */
	__vo uint32_t ODR;      /* GPIO port mode register Address Offset : 0x00 */
	__vo uint32_t BSRR;      /* GPIO port mode register Address Offset : 0x00 */
	__vo uint32_t LCKR;
	__vo uint32_t AF[2];
}GPIO_RegDef_t;
...
/*
 * GPIO Peripheral Definitions (Peripherals Base addresses type casted to GPIO_RegDef_t
 */
...
/*
 * Macros to reset GPIOx peripherals  (do......while....condition zero loop)
 */
